...
})({"dXqbF":[function(require,module,exports,__globalThis) {
...
class Book extends Product {
    constructor(id, price, description, author, title){
        super(id, price, description), this.id = id, this.price = price, this.description = description, this.author = author, this.title = title;
    }
    display() {
        super.display();
...
class Electronic extends Product {
    constructor(id, price, description, brand, model){
        super(id, price, description), this.id = id, this.price = price, this.description = description, this.brand = brand, this.model = model;
    }
    display() {
        super.display();
...
},{}]},["dXqbF","aPy6N"], "aPy6N", "parcelRequire7b07", {})

//# sourceMappingURL=inheritance.fcf0876d.js.map
